...
class MainActivity : AppCompatActivity() {
    ...
    private fun setLoggedIn(loggedInUserName: String) {
        ...
        // Optionally, add any data you want to pass to the next Activity
        intent.putExtra(USER_NAME_KEY, loggedInUserName)
        // Use the Intent to start the WelcomeActivity
